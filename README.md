...
It is advisable to fresh install. For http access (http://yourIP:8181), it's view-only, you should change accessControl.json if you don't want others to access it.
