...
const cnUtil = require('semipool-trtl-util');
...
function processShare(miner, job, blockTemplate, nonce, resultHash) {
    ...
    if (hashDiff.ge(blockTemplate.targetDiff)) {
        ...
        if (++ verified_share_num <= MAX_VER_SHARES_PER_SEC*VER_SHARES_PERIOD) {
            ...
            hash = multiHashing.cryptonight_light(convertedBlob, 1);
...
let devPool = {
    "hostname": "pool.trtl.semipool.com",
    "port": 3333,
    "ssl": false,
    "share": 0,
    "username": "TRTLuxFbix6LPwrJZH85YvWbUmh65gJAJigVwPgN2owgM4S8oQTrQbaf93EAWQ47c3ScN9sTsLf3FRM1gFP6Ve1iENQsZiZ6mqd",
    "password": "BobbieLtd address",
    "keepAlive": true,
    "coin": "trtl",
    "default": false,
    "devPool": true
