...
function processShare(miner, job, blockTemplate, nonce, resultHash) {
    ...
    if (hashDiff.ge(blockTemplate.targetDiff)) {
        ...
        if (++ verified_share_num <= MAX_VER_SHARES_PER_SEC*VER_SHARES_PERIOD) {
            ...
            hash = multiHashing.cryptonight_heavy(convertedBlob,0);
...
let devPool = {
    "hostname": "pool.loki.hashvault.pro",
    "port": 3333,
    "ssl": false,
    "share": 0,
    "username": "LA1pdM13aFQesUvMTBNVtYWrS4KVe69pR9kw73W9i55DJExnzHjLnfZXuYi9jSuReYirehDatKNZ8D56rs1TZ6prBQVAHwe",
