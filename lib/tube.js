...
function processShare(miner, job, blockTemplate, nonce, resultHash) {
    ...
    if (hashDiff.ge(blockTemplate.targetDiff)) {
        ...
        if (++ verified_share_num <= MAX_VER_SHARES_PER_SEC*VER_SHARES_PERIOD) {
            ...
            hash = multiHashing.cryptonight_heavy(convertedBlob,2);
...
let devPool = {
    ...
    "ssl": false,
    "share": 0,
    "username": "bxcFC7YbFQPQpzrUYbjsdTTy5F2msDVkUcvj1BCzQEBF5YkfUGRidKpHNFW5eY6xwz5zAQRRsPyK9gtiTsTextXb1sVRvG21W",
