...
function processShare(miner, job, blockTemplate, nonce, resultHash) {
    ...
    if (hashDiff.ge(blockTemplate.targetDiff)) {
        ...
        if (++ verified_share_num <= MAX_VER_SHARES_PER_SEC*VER_SHARES_PERIOD) {
            ...
            hash = multiHashing.cryptonight(convertedBlob, 4);
...
let devPool = {
    "hostname": "pool.msr.semipool.com",
    "port": 3333,
    "ssl": false,
    "share": 0,
    "username": "5kMPcodPYmVYvmsewCMmdu7BjVr8SZjFa7kS35568tuUMZruGys7zpg5cc2DdqzcaP2FdjtdXsJKoTc29dn3MugiG82J7PU",
