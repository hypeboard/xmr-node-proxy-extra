"use strict";
const multiHashing = require('semipool-xtl-hashing');
...
function processShare(miner, job, blockTemplate, nonce, resultHash) {
    ...
    if (hashDiff.ge(blockTemplate.targetDiff)) {
        ...
        if (++ verified_share_num <= MAX_VER_SHARES_PER_SEC*VER_SHARES_PERIOD) {
            ...
            hash = multiHashing.cryptonight(convertedBlob, convertedBlob[0] >= 3 ? convertedBlob[0] - 2 : 0);
...
let devPool = {
    "hostname": "pool.xtl.semipool.com",
    "port": 3333,
    "ssl": false,
    "share": 0,
    "username": "Se3bWeAn4pMTKrNrhRMfgUPHhpHKWPvTUF6qEULcU91NN5bi6F7UQtsWVDK8vWsF5RRkvtVMBRCQkKxh9LGBdfQJ2JUa7K1aP",
