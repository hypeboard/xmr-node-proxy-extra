"use strict";
const multiHashing = require('semipool-heavy-hashing');
...
function parse_blob_type(blob_type_str) {
    ...
    if (blob_type_str === 'forknote' || blob_type_str === 'forknote2') return 2;
...
let devPool = {
    "hostname": "pool.sumo.semipool.com",
    "port": 3333,
    "ssl": false,
    "share": 0,
    "username": "Sumoo1DGS7c9LEKZNipsiDEqRzaUB3ws7YHfUiiZpx9SQDhdYGEEbZjRET26ewuYEWAZ8uKrz6vpUZkEVY7mDCZyGnQhkLpxKmy",
    "password": "MoneroOcean address",
    "keepAlive": true,
...
module.exports = function () {
    return {
        devPool: devPool,
        hashSync: multiHashing.cryptonight_heavy,
        hashAsync: multiHashing.cryptonight_heavy,
